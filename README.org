* UNDER CONSTRUCTIION
This repository was forked from https://github.com/aidanscannell/my-org-resume and is currently being developed.

* Creating a CV/Resume in Org-Mode using LaTeX Templates :emacs:org_mode:cv:resume:
